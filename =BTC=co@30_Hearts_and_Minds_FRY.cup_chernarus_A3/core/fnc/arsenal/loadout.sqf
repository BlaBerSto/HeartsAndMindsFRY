...
private _cargo_uniform = [["acc_flashlight", 1], ["ACE_CableTie",5], ["ACE_MapTools", 1], ["ACE_RangeTable_82mm", 1]];

//Tweak uniform medical item depends on medical parameters
private _medical = [["ACE_fieldDressing", 3], ["ACE_tourniquet", 4], ["ACE_painkillers", 3]];
...
private _array = switch (_type) do {
    case 6: {
        [_weapon_sniper, ["rhs_acc_pso1m21"]];
    };
    case 7: {
...
private _backpackMedical = [["ACE_fieldDressing", 10], ["ACE_painkillers", 12], ["ACE_bloodIV", 2], ["ACE_bloodIV_250", 2], ["ACE_bloodIV_500", 1]];
...
private _cargos = [
    [],
    [_backpack, [["rhssaf_mag_brd_m83_green", 3, 1], ["rhssaf_mag_brd_m83_orange", 1, 1]] + _backpackMedical],
    ...
    [_backpack, [["ACE_Sandbag_empty", 1],["ACE_EntrenchingTool", 1]]],
    [],
...
private _loadout = if (_isDay) then {
    [
        ...
        [_vest, [
            ["rhssaf_mag_brd_m83_green", 2, 1],
            [_weaponMagazine, 7, _weaponCount],
            ["rhssaf_mag_brd_m83_orange", 2, 1],
            ["rhssaf_mag_brd_m83_yellow", 1, 1],
            [_pistolMagazine, 1, _pistolCount],
            ["ACE_M84", 1, 1],
            ["rhssaf_mag_br_m75", 3, 1]
        ]],
        _cargos select _type, _helmet, _hood, _binocular_array,
        ["ItemMap", "", _radio_item, "ItemCompass", "ItemWatch", ""]
    ]
} else {
    [
        [_weapon, "", "", _optics select _isDay, [_weaponMagazines param [1, _weaponMagazine], _weaponCount], [], _bipod_item],
        _launcher_array,
        [_pistol, "", "", "", [_pistolMagazine, _pistolCount], [], ""],
        [_uniform, _cargo_uniform],
        [_vest, [
            ["rhssaf_mag_brd_m83_green", 1, 1],
        ...
        _cargos select _type, _helmet, _hood, _binocular_array,
        ["ItemMap", "", _radio_item, "ItemCompass", "ItemWatch", _night_vision]
    ]
};
