...
## Hideout
The hideouts are a place where the KLA organize their movements.
...
If you want to defeat the KLA, you need to destroy all their hideouts.
...
## Reputation
### System:
At the beginning you have a very low reputation level, so civilians won't help you in revealing important information about the KLA, they will likely lie instead. Reputation can be ask to civilian.
### Good actions:
Helping the local population by fighting the KLA, disarming IED's, heal civilians, put civilians killed by players in grave near church or chapel (50 m), give banana, remove tag with spraypaint red, succeed side mission and destroy cache/hideout will rise your reputation.
### Bad actions:
...
## Traffic
Civilians are travelling by vehicle across cities. If your reputation is higher than normal, you can ask for a lift to a location chosen on the map. If you bump into a KLA patrol, don't worry, the civilian driver will do their best to hide you in the car.
